...
<!--导航条-->
   <nav class="navbar navbar-default navbar-fixed-top">      
	<a class="navbar-brand glyphicon glyphicon-folder-open">&nbsp;题库管理系统>错误提示</a>
   </nav>
<!--导航条结束-->
<!-- 内容实体开始 -->
	<div class="container" style="width: 63%;font-family:serif;font-size: x-large;">
		<ul class="list-group" style="margin-top: 20%">
		  <li class="list-group-item list-group-item-success glyphicon glyphicon-warning-sign text-center">&nbsp;提示！</li>
		  <li class="list-group-item list-group-item-danger text-center">用户或密码不能为空！</li>
		</ul>
