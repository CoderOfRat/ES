...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<ul class="nav navbar-nav navbar-right center-block">
			<li><a class="glyphicon glyphicon-arrow-left" <%if(request.getParameter("who").equalsIgnoreCase("admin")){%>
	...
	<div class="container"
		...
		<ul class="list-group">
			<li
				class="list-group-item list-group-item-success glyphicon glyphicon-list-alt text-center">&nbsp;C语言判断题预览如下</li>
			<li class="list-group-item list-group-item-info" id="grade">
				...
				</span> <br /> <input type="radio" name="judge<%=i %>" value="male" />正确
				&nbsp;&nbsp;<input type="radio" name="judge<%=i %>" value="female" />错误<br>
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < teBut.length; i++) {
			teBut[i].onclick = function() {
				...
				console.log(this.id);
				xmlHttp.open("post", "deleteQuestionServletCJ", true);
		...
		/* 	function reload(){
		 ...
		 console.log(this.id);
		 xmlHttp.open("post","deleteQuestionServlet",true);
