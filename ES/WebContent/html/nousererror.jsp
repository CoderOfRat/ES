...
<!-- 内容实体开始 -->
	<div class="container" style="width: 63%;font-family:serif;font-size: x-large;">
		<ul class="list-group" style="margin-top: 20%">
		  <li class="list-group-item list-group-item-success glyphicon glyphicon-ban-circle text-center">&nbsp;提示！</li>
		  <li class="list-group-item list-group-item-danger text-center">用户不存在！</li>
		</ul>
