...
<body>
	...
	<div class="container"
		...
		<ul class="list-group">
			<li
				class="list-group-item list-group-item-success glyphicon glyphicon-list-alt text-center">&nbsp;Java简答题预览如下</li>
			<li class="list-group-item list-group-item-info" id="grade">
				...
				</span> <br /> <textarea class="form-control" rows="3" name="solution<%=i %>"
								placeholder="请填写本题答案">答：</textarea>
	...
	<script type="text/javascript">
		...
		for (var i = 0; i < teBut.length; i++) {
			teBut[i].onclick = function() {
				...
				console.log(this.id);
				xmlHttp.open("post", "deleteQuestionServletJJQ", true);
